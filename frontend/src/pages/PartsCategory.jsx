...
const SECTION_META = {
  mecanique:  { label: "Mécanique",  color: "text-blue-600",  bar: "from-blue-700 to-blue-500", iconStroke: "#2563eb" },
  electrique: { label: "Électrique", color: "text-blue-600",  bar: "from-blue-700 to-blue-500", iconStroke: "#2563eb" },
  carrosserie:{ label: "Carrosserie",color: "text-blue-600",  bar: "from-blue-700 to-blue-500", iconStroke: "#2563eb" },
};
      ...
      <div className="border-b border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-3">
            {vehicle ? (
              <Link to={`/vehicule/${vehicle.vin}`} className="hover:text-blue-600 inline-flex items-center gap-1" data-testid="back-to-vehicle">
          ...
          <div className="text-xs font-semibold uppercase tracking-[0.3em] text-blue-600 mb-2">Catégorie</div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
          {data.categories.map((c) => (
            <Link
              ...
              className="group relative bg-white border border-slate-200 rounded-sm overflow-hidden hover:border-blue-600 hover:shadow-xl transition-all"
            ...
            >
              ...
              <div className="relative bg-zinc-50 h-40 flex items-center justify-center p-6 overflow-hidden">
                <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-blue-600/0 group-hover:bg-blue-600/10 rounded-full blur-2xl transition-colors" />
                <img
                  src={c.image}
                  alt={c.label}
              ...
              <div className="px-4 py-4 border-t border-slate-100 text-center">
                <span className="font-display text-sm font-bold text-slate-800 group-hover:text-blue-600 tracking-wide uppercase transition-colors">
                  {c.label}
                </span>
              </div>
            </Link>
